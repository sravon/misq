                ...
                {products.map((product) => (
                  <div key={product.id} className="relative">
                    <div className="aspect-h-1 aspect-w-1 w-full rounded-md bg-gray-200 lg:aspect-none lg:h-80">
                      ...
                      />
                      <div className="absolute bottom-44 p-2 bg-black text-white">5.0/15</div>
                    </div>
                    ...
                    <button className="w-full bg-lime-600 hover:bg-lime-500 mt-2 px-2 py-3 rounded-lg text-white text-lg">Buy now</button>
                  </div>
                ))}
              </div>
            </section>
